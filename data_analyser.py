...
def calculate_nvt_ratio(market_capitalization_daily_value, transaction_valumes_90_days):
    """
    market cap / transaction volume in USD
    high value => overvalued
    low value => undervalued
    :return:
    """

    sma_90days = simple_moving_average(transaction_valumes_90_days)

    return market_capitalization_daily_value / sma_90days


def simple_moving_average(prices:typing.List):
